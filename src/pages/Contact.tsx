              ...
              <div className="space-y-6">
                ...
                <div className="bg-accent/30 p-6 rounded-lg">
                  ...
                  <div className="space-y-2">
                    <p className="text-muted-foreground">
                      <span className="font-medium">Email:</span> info@magicspaceinterior.com
                    </p>
                    <p className="text-muted-foreground">
                ...
                <div className="bg-accent/30 p-6 rounded-lg">
                  ...
                  <div className="flex gap-4">
                    ...
                    <a href="#" className="p-2 rounded-full bg-primary text-primary-foreground hover:opacity-80 transition-opacity">IG</a>
